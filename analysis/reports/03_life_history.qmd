...
Quantify great whales' pace-of-life relative to mammals. Account for effects of body size and phylogeny. See [Jeschke and Kokko (2009)](https://doi.org/10.1007/s10682-008-9276-y) *Evolutionary Ecology*, [Revell (2014)](https://doi.org/10.1111/j.2041-210X.2011.00169.x) *Methods in Ecology and Evolution*, [Soriano-Redondo et al. (2020)](https://doi.org/10.1038/s41467-020-19256-0) *Nature Communications*.
...
lht_plots <- tar_read("lht_plots")

cowplot::plot_grid(plotlist = lht_plots, nrow = 2)
```

## Phylogeny

Now we account for phylogeny. Using a mammal tree from [Upham et al. (2019) *PLOS*](https://doi.org/10.1371/journal.pbio.3000494), downloaded from [VertLife](http://verlife.org/phylosubsets).
